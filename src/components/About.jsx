      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Parth Agrawal</span>, a B.Tech student in Information Technology (Minor in Entrepreneurship) at <strong className="text-white">Indian Institute of Information Technology, Allahabad</strong> with a CGPA of <span className="text-red-500 font-bold">9.24/10</span>.
              </p>
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">Education & Accolades</h3>
